...
Automated system for keeping container image versions up-to-date in `docker/deployment-tool/defaults.yaml`.
...
vim docker/deployment-tool/defaults.yaml

# 2. Try to commit
git add docker/deployment-tool/defaults.yaml
