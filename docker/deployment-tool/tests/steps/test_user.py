...
class TestUserStepConfigCollection:
    ...
    def test_collect_config_email_auth_non_interactive(
        self, defaults_email_auth, tmp_path
    ):
        """Test config collection with email auth in non-interactive mode."""
        step = UserStep(
            output_dir=tmp_path, defaults=defaults_email_auth, interactive=False
        )
        step.config = {
    ...
    def test_collect_config_no_email_auth(
        self, defaults_no_email_auth, tmp_path, monkeypatch
    ):
        ...
        step = UserStep(
            output_dir=tmp_path, defaults=defaults_no_email_auth, interactive=True
        )
    ...
    def test_collect_config_username_auth(
        self, defaults_no_email_auth, tmp_path, monkeypatch
    ):
...
class TestUserStepSecretGeneration:
    ...
    def test_generate_secrets_email_auth_disabled(
        self, defaults_no_email_auth, tmp_path
    ):
    ...
    def test_generate_secrets_email_auth_empty_emails(
        self, defaults_email_auth, tmp_path
    ):
