...
class TestDeploymentConfigurator:
    ...
    def test_run_resumes_from_interrupted_state(
        ...
        class RequiredStep(_TestStep):
            def __init__(self, *args, **kwargs):
                super().__init__(*args, **kwargs, name="required", config_to_return={"required_key": "required_value"})

        class EmailStep(_TestStep):
            def __init__(self, *args, **kwargs):
                super().__init__(*args, **kwargs, name="email", config_to_return={"email_key": "email_value"})

        class TelemetryStep(_TestStep):
            def __init__(self, *args, **kwargs):
                super().__init__(*args, **kwargs, name="telemetry", config_to_return={"telemetry_key": "telemetry_value"})

        class DatabaseStep(_TestStep):
            def __init__(self, *args, **kwargs):
                super().__init__(*args, **kwargs, name="database", config_to_return={"database_key": "database_value"})
